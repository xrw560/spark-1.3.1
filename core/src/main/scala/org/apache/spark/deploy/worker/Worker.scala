...
private[spark] class Worker(
    ...
    val INITIAL_REGISTRATION_RETRY_INTERVAL = (math.round(10 * REGISTRATION_RETRY_FUZZ_MULTIPLIER)).seconds
    val PROLONGED_REGISTRATION_RETRY_INTERVAL = (math.round(60 * REGISTRATION_RETRY_FUZZ_MULTIPLIER)).seconds
    ...
    override def receiveWithLogging = {
        ...
        //TODO Master发送给Worker的消息，让Worker启动Executor，LaunchExecutor是一个Case Class，里面封装了以后要启动的Executor的信息
